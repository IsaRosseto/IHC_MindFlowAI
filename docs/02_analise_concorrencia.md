...
|---|---|---|---|---|
| Noldus FaceReader | Análogo | É um software onde consegue identificar diversas impressões faciais, como alegria, tristeza, etc... onde nosso software busca tambem fazer a identificação dessas impressões. | H | Analisar |
